  ...
  return (
    <div className="w-[90%] sm:w-[90%]  mx-auto lg:w-105 flex flex-col justify-center  overflow-x-hidden my-20 p-2 ">
      <div className="w-full lg:w-92.75 mx-auto">
        ...
        <p className="text-text-neutral-darker text-[12px] w-full lg:w-92.75">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-primary text-white rounded-[10px] py-2 cursor-pointer flex justify-center items-center gap-1"
        >
