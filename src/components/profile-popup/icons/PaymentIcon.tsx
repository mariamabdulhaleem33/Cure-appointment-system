...
export const PaymentIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => {
  return (
    <svg 
      width="24" 
      height="24" 
    ...
    >
      ...
      />
      <path 
        d="M19.0003 8.07617C19.9754 8.17208 20.6317 8.38885 21.1216 8.87873C22.0003 9.75741 22.0003 11.1716 22.0003 14.0001C22.0003 16.8285 22.0003 18.2427 21.1216 19.1214C20.2429 20.0001 18.8287 20.0001 16.0003 20.0001H11.0003C8.17187 20.0001 6.75766 20.0001 5.87898 19.1214C5.38909 18.6315 5.17233 17.9751 5.07642 17" 
        stroke="#1C274C" 
        strokeWidth="1.5"
      />
      <path 
