    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          />
          <Link to='/Map' className="flex justify-between items-center rounded-xl border px-4 py-3 text-sm cursor-pointer"><LuMapPinned className="pr-1 text-lg"/><span>Map</span>
          </Link>
        </div>
        ...
        {/* pagination */}
        <div className={`mt-10 flex ${isFirstPage ? "justify-center" : "justify-between"}`}>
          {!isFirstPage && (
            <button
